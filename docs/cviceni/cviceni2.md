...
<!-- <figure markdown>
  ![Prostorové funkce](../assets/cviceni2/prost_funkce_srovnani.png "Prostorové funkce")
...
- [Pobočky](../assets/cviceni2/PobockyCP_PlzenskyKraj.zip) České pošty v Plzeňském kraji (bodová vrstva)
...
<figure markdown>
  ![Select](../assets/cviceni2/SELECT_obce.png "Select obce")
...
<figure markdown>
  ![DQ](../assets/cviceni2/DQ_posta.png "Definition Query pošty")
  <figcaption>Definition Query pro vrstvu poboček pošty</figcaption>
</figure>

<figure markdown>
  ![Map 1](../assets/cviceni2/MAP_pred-spatial-join.png "Mapa 1")
...
<figure markdown>
  ![Spatial join](../assets/cviceni2/SPATIALJOIN_obce-pobocky.png "Spatial join")
...
<figure markdown>
  ![Select by attribute](../assets/cviceni2/SELECT_pocet-pobocek.png "Atributový dotaz")
  <figcaption>Atributový dotaz na vrstvu obcí</figcaption>
</figure>
...
<figure markdown>
  ![Clip features](../assets/cviceni2/CLIP_pobocky.png "Clip")
  <figcaption>Oříznutí vrstvy poboček aktivními prvky ve vrstvě obcí.</figcaption>
</figure>

<figure markdown>
  ![Map 2](../assets/cviceni2/MAP_spatial-join-plus-dq.png "Mapa 2")
...
<figure markdown>
  ![Buffer](../assets/cviceni2/BUFFER_pobocky.png "Buffer")
...
<figure markdown>
  ![Map 3](../assets/cviceni2/MAP_buffer-Klatovy.png "Mapa 3"){ width="500" }
...
<figure markdown>
  ![Add field](../assets/cviceni2/AT_add-field.png "Přidání atributu")
...
<figure markdown>
  ![Map 4](../assets/cviceni2/MAP_zachovane-pobocky.png "Mapa poboček")
...
<figure markdown>
  ![Mapa](../assets/cviceni2/culturemile.png "Mapa"){ width=600px }
